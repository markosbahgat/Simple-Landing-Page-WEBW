...
const SecondFeaturesSection = (props: Props) => {
	return (
		<div className='relative mt-24 '>
			<div className='lg:mx-auto lg:grid max-w-[90%] lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8'>
				...
				<div className='mt-12 sm:mt-16 lg:col-start-1 lg:mt-0'>
					<div className=' lg:relative lg:m-0 lg:h-full lg:px-0'>
						<img
							className='w-full rounded-xl relative lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none'
							src='/assets/thirdSection.png'
							alt='Customer profile user interface'
						/>
						<div className='w-[1000px] h-[1000px] absolute top-[50%] translate-y-[-50%] -left-[100%]  -z-10'>
							<img
