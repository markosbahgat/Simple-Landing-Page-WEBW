...
const Footer = (props: Props) => {
	return (
		<footer className='bg-[#333333] mt-60' aria-labelledby='footer-heading'>
					...
					<div className='mt-8 xl:mt-0'>
						...
						<form className='mt-4 sm:flex sm:max-w-md'>
							...
							<div className='mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
								<button
									type='submit'
									className='flex w-full items-center justify-center rounded-md border border-transparent bg-[#FF6057] py-2 px-4 text-base font-medium text-white hover:bg-[#FF6057] focus:outline-none focus:ring-2 focus:ring-[#FF6057] focus:ring-offset-2 focus:ring-offset-[#FF6057]'>
									Subscribe
								</button>
							</div>
						</form>
